function MATSIM_Exp(gd, seed, volfracs, npDiams, Perms, Conds, freq, runID)
...
%npDiams = 7E-9
% 20 um
tSamp   = 75E-9       % Half sample thickness to capture adequate resolution of NPs...
...
for(i = 1:length(VolFrac))
    ...
    MatGenTQE_D(gd, rads, shells, ovlp, VolFrac(i), runID, seed);
    MatGenTQE_G(gd, rads, shells, ovlp, VolFrac(i), runID, seed);
    toc
end
