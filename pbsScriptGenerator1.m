...
basefnm = "QESIM_S2_C" + runCase + "_VF"
...
for i = 1:10
    ...
    elseif runCase == 2
        runLine = "matlab -r "+char(39)+"QESIM_Exp(90, $PBS_ARRAYID, "+ vfs(i) +", 7E-9, [2.5, 1], [2.8776E-9, 5.87E3], 10000, 99101)"+char(39)+"\n";
    elseif runCase == 3
    ...
    fid = fopen(fnms(i),'wt');
    fprintf(fid, "# QE MSTest V2 - C"+runCase+"  Nano Copper Fillers\n");
    fprintf(fid, "#PBS -N QESIM2_C"+runCase+"_VF"+i+"\n");
...
% write shell script
fid = fopen("RunJobs2_Case"+runCase+".sh",'wt');
